...
## Goal
Maintain a clear execution roadmap for **soccer-prediction-betting-system** based on current codebase signals.

## Current Baseline
- Stack: Python
- Codebase scan size: 49 files (capped)
- Test signal: Test-named files detected
- CI workflows present: Yes
- GitHub Remote: igor-kan/soccer-prediction-betting-system
