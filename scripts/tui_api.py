#!/usr/bin/env python3
"""Curses TUI client for Soccer Prediction and Betting API."""
...
def draw(stdscr: curses.window, base_url: str, output: str) -> None:
    ...
    title = f"Soccer API TUI  |  base: {base_url}"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="TUI for Soccer API")
